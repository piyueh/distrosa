...
if __name__ == "__main__":
    ...
    if args.new_run:
        ...
        numpy.savez_compressed(figdir.joinpath("diagapprox.meta.npz"), **meta)
        numpy.savez_compressed(figdir.joinpath("diagapprox.outs.npz"), **outs)
        numpy.savez_compressed(figdir.joinpath("diagapprox.times.npz"), **times)
        numpy.savez_compressed(figdir.joinpath("diagapprox.errs.npz"), **errs)
        numpy.savez_compressed(figdir.joinpath("diagapprox.convs.npz"), **convs)
    else:
