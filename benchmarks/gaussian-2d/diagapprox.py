...
if __name__ == "__main__":
    ...
    numpy.savez(figdir.joinpath("diagapprox.meta.npz"), **meta)
    numpy.savez(figdir.joinpath("diagapprox.outs.npz"), **outs)
    numpy.savez(figdir.joinpath("diagapprox.times.npz"), **times)
    numpy.savez(figdir.joinpath("diagapprox.errs.npz"), **errs)
    numpy.savez(figdir.joinpath("diagapprox.convs.npz"), **convs)
